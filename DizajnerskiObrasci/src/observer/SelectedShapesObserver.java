...
public class SelectedShapesObserver implements PropertyChangeListener{
	...
	// na pcs mogu da se prijave samo pcl sto znaci da nasa klasa treba da implementira pcl
	...
	//nista
		if(size == 0) {
			...
			//samo jedan selektovan - moze sve 
